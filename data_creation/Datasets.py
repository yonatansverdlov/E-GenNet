...
from .data_utils import group_same_size, batch_same_size, create_k_chains, create_pair_A, create_pair_B, create_hard
...
class hard_dataset(torchDataset):
    """
    Hard experiments dataset.
    """
    def __init__(self, config: easydict):
        """
        Creates dataset object, given a tuple type.
